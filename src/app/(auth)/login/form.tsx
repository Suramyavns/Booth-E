...
export default function LoginForm(){
    return(
        ...
        className="flex flex-col justify-center items-center gap-10 p-6 rounded-xl h-fit w-80">
            <p className="self-start text-2xl font-semibold">Do I know you?</p>
            <div className="flex flex-col gap-6 justify-center items-center w-full">
                ...
                <span className="flex gap-2">
                    ...
                    <button className="btn">
                        Sign-In with Google <GrGoogle />
                    </button>
                </span>
                <p className="flex gap-1">
                    I don&apos;t ?
                    <Link className="opacity-70 hover:opacity-100 ease-in-out duration-300" href='/register'>Sign-Up instead!</Link>
                </p>
            </div>
        </div>
    )
